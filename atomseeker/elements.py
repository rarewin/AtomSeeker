...
class AtomMatrix:
    ...
    def __init__(self, matrix_data):
        """
        In QuickTime File Format, Matrix structure is stored in the order of a, b, u, c, d, v, x, y, w,
        where
        ...
        self.a, self.b, self.u, self.c, self.d, self.v, self.x, self.y, self.w = matrix_data
    ...
    def __str__(self):
        return "[[%16.16f %16.16f %2.30f] [%16.16f %16.16f %2.30f] [%16.16f %16.16f %2.30f]]" % self.matrix()
